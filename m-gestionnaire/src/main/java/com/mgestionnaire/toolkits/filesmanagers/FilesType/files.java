 ...
 */
package com.mgestionnaire.toolkits.filesmanagers.FilesType;
...
public class files {
    ...
    public String MoveTo_other(String str_Path_Of_File, String directoryname, String new_name_file) {
