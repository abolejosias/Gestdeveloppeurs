 ...
 */
package com.mgestionnaire.toolkits.log;

import com.mgestionnaire.toolkits.*;
...
import com.mgestionnaire.toolkits.utils.date;
...
public class Category extends files implements Log {
    ...
    public void info(Object arg0) {
        if (arg0 == null) {
            ...
            System.out.println("dans create file logger ************************************************************************");
    ...
    public void error(Object arg0) {
        if (arg0 == null) {
            System.out.println("LOGGER NULL");
              ...
              System.out.println("dans create file logger ************************************************************************"+fichierSortie);
    ...
    public Category() {
        ...
        OTxtFiles.setPath_outut(commonparameter.PathLogFile + this.OTxtFiles.getName());
