...
url_transaction_senddemande = "senddemande"
        ...
        switch (myId) {
            ...
            case "envoyerdemande":
                swal({
                    ...
                    text: "Etes-vous s\373r de vouloir envoyer votre demande de participation ?'",
                    icon: "warning",
                    buttons: {
                        cancel: {
...
function senddemande(idprojets) {
    $.ajax({
        url: url_transaction_senddemande, // La ressource cibl\351e
        type: 'POST', // Le type de la requ�te HTTP.
...
function redirectpage() {
    window.location = 'listedesprojets';
}